...
from query_strategies.bayesianLeastConfidence import bayesianLeastConfidenceSampling
...
if __name__ == "__main__":
    ...
    file_path = os.path.join("..", "..", "..", "DVI_data", "active_learning", "bayesianLeastConfidence", "resnet18", DATA_NAME)
    ...
    strategy = bayesianLeastConfidenceSampling(task_model, task_model_type, n_pool, idxs_lb, 10, DATA_NAME, "resnet18", gpu=GPU, **args)
