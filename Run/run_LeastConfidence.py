...
if __name__ == "__main__":
    ...
    file_path = os.path.join("..", "..", "..", "DVI_data", "active_learning", "LeastConfidence", "resnet18", DATA_NAME)
    ...
    strategy = LeastConfidenceSampling(task_model, task_model_type, n_pool, idxs_lb, 10, DATA_NAME, "resnet18", gpu=GPU, **args)
    ...
    for rd in range(1, NUM_ROUND+1):
        ...
        # query new samples
        t0 = time.time()
        new_indices,_ = strategy.query(complete_dataset, NUM_QUERY)
        ...
        # resnet_model = strategy.task_model
